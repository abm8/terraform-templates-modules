...
module "example" {
    ...
    path_match          = list(string)
  	 ...
  	 edge_hostname_type  = <string> | default: "SBD"
...
| <a name="input_default_origin"></a> [default\_origin](#input\_default\_origin) | n/a | `string` | n/a | yes |
...
| <a name="input_cache_key_query_params_behavior"></a> [cache\_key\_query\_params\_behavior](#input\_cache\_key\_query\_params\_behavior) | n/a | `string` | `"IGNORE_ALL"` | no |
...
| <a name="input_client_country"></a> [client\_country](#input\_client\_country) | n/a | `string` | `"UNKNOWN"` | no |
| <a name="input_content_catalog_size"></a> [content\_catalog\_size](#input\_content\_catalog\_size) | n/a | `string` | `"UNKNOWN"` | no |
| <a name="input_content_popularity_distribution"></a> [content\_popularity\_distribution](#input\_content\_popularity\_distribution) | n/a | `string` | `"UNKNOWN"` | no |
| <a name="input_content_type"></a> [content\_type](#input\_content\_type) | n/a | `string` | `"HD"` | no |
| <a name="input_cors_allow_credentials"></a> [cors\_allow\_credentials](#input\_cors\_allow\_credentials) | n/a | `string` | `"true"` | no |
| <a name="input_cors_allow_headers"></a> [cors\_allow\_headers](#input\_cors\_allow\_headers) | n/a | `string` | `"origin,range,hdntl,hdnts,CMCD-Request,CMCD-Object,CMCD-Status,CMCD-Session"` | no |
| <a name="input_cors_allow_methods"></a> [cors\_allow\_methods](#input\_cors\_allow\_methods) | n/a | `string` | `"GET,POST,OPTIONS"` | no |
| <a name="input_cors_allow_origin"></a> [cors\_allow\_origin](#input\_cors\_allow\_origin) | n/a | `string` | `"*"` | no |
| <a name="input_cors_expose_headers"></a> [cors\_expose\_headers](#input\_cors\_expose\_headers) | n/a | `string` | `"Server,range,hdntl,hdnts,Akamai-Mon-Iucid-Ing,Akamai-Mon-Iucid-Del,Akamai-Request-BC"` | no |
| <a name="input_cors_max_age"></a> [cors\_max\_age](#input\_cors\_max\_age) | n/a | `string` | `"86400"` | no |
...
| <a name="input_dash_media_encryption"></a> [dash\_media\_encryption](#input\_dash\_media\_encryption) | n/a | `bool` | `false` | no |
...
| <a name="input_edge_hostname_type"></a> [edge\_hostname\_type](#input\_edge\_hostname\_type) | Edge hostname mode: SBD (Secure By Default, no cert needed), EDGESUITE (aka Freeflow, <hostname>.edgesuite.net), EDGEKEY (aka ESSL, <hostname>.edgekey.net), or AKAMAIZED\_HOSTNAME (<label>.akamaized.net, hostname and edge hostname are identical). | `string` | `"SBD"` | no |
| <a name="input_enable_cors_policy"></a> [enable\_cors\_policy](#input\_enable\_cors\_policy) | n/a | `bool` | `true` | no |
| <a name="input_enable_dash"></a> [enable\_dash](#input\_enable\_dash) | n/a | `bool` | `true` | no |
| <a name="input_enable_debug"></a> [enable\_debug](#input\_enable\_debug) | n/a | `bool` | `true` | no |
| <a name="input_enable_dynamic_throughput_optimization"></a> [enable\_dynamic\_throughput\_optimization](#input\_enable\_dynamic\_throughput\_optimization) | n/a | `bool` | `true` | no |
| <a name="input_enable_hds"></a> [enable\_hds](#input\_enable\_hds) | n/a | `bool` | `true` | no |
| <a name="input_enable_hls"></a> [enable\_hls](#input\_enable\_hls) | n/a | `bool` | `true` | no |
| <a name="input_enable_http3"></a> [enable\_http3](#input\_enable\_http3) | n/a | `bool` | `true` | no |
| <a name="input_enable_segmented_content_protection"></a> [enable\_segmented\_content\_protection](#input\_enable\_segmented\_content\_protection) | n/a | `bool` | `false` | no |
| <a name="input_enable_smooth"></a> [enable\_smooth](#input\_enable\_smooth) | n/a | `bool` | `true` | no |
...
| <a name="input_forward_host_header"></a> [forward\_host\_header](#input\_forward\_host\_header) | n/a | `string` | `"REQUEST_HOST_HEADER"` | no |
| <a name="input_hls_media_encryption"></a> [hls\_media\_encryption](#input\_hls\_media\_encryption) | n/a | `bool` | `false` | no |
| <a name="input_http2_enabled"></a> [http2\_enabled](#input\_http2\_enabled) | n/a | `bool` | `true` | no |
| <a name="input_ip_behavior"></a> [ip\_behavior](#input\_ip\_behavior) | IP version behavior for the edge hostname: IPV4, IPV6\_COMPLIANCE, or IPV6\_PERFORMANCE. | `string` | `"IPV4"` | no |
| <a name="input_min_tls_version"></a> [min\_tls\_version](#input\_min\_tls\_version) | n/a | `string` | `"DYNAMIC"` | no |
...
| <a name="input_origin_authentication_method"></a> [origin\_authentication\_method](#input\_origin\_authentication\_method) | n/a | `string` | `"AUTOMATIC"` | no |
| <a name="input_origin_country"></a> [origin\_country](#input\_origin\_country) | n/a | `string` | `"UNKNOWN"` | no |
...
| <a name="input_segment_duration_dash"></a> [segment\_duration\_dash](#input\_segment\_duration\_dash) | n/a | `string` | `"SEGMENT_DURATION_6S"` | no |
| <a name="input_segment_duration_hds"></a> [segment\_duration\_hds](#input\_segment\_duration\_hds) | n/a | `string` | `"SEGMENT_DURATION_6S"` | no |
| <a name="input_segment_duration_hls"></a> [segment\_duration\_hls](#input\_segment\_duration\_hls) | n/a | `string` | `"SEGMENT_DURATION_10S"` | no |
| <a name="input_segment_duration_smooth"></a> [segment\_duration\_smooth](#input\_segment\_duration\_smooth) | n/a | `string` | `"SEGMENT_DURATION_2S"` | no |
| <a name="input_segmented_media_optimization_behavior"></a> [segmented\_media\_optimization\_behavior](#input\_segmented\_media\_optimization\_behavior) | n/a | `string` | `"ON_DEMAND"` | no |
...
| <a name="input_verification_mode"></a> [verification\_mode](#input\_verification\_mode) | n/a | `string` | `"PLATFORM_SETTINGS"` | no |
